...
-- -  -   -    -     -      -       -        -
-- *** The tables above have no FKs and are not used as FKs in other tables

IF EXISTS(SELECT * FROM sys.tables WHERE name='TagCategoriesTable')
	DROP TABLE TagCategoriesTable
GO
...
CREATE TABLE TagCategoriesTable ( 
	TagNameId		int primary key identity(1,1) not null,
	TagParentId		int foreign key references TagCategoriesTable(TagNameId) null,	
	TagName		varchar(32)  NOT NULL,
	TagAddedDate	datetime NOT NULL DEFAULT GETDATE() 
 ) 
GO
